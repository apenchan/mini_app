...
arrangement = Arrangement.create(
	[
		{
			price: 60.99, occasion: "Valentines Day", 
			card_description: "Roses are red and Violets are blue, can't wait to be near you"
		},{
			price: 29.99, occasion: "I'm sorry for you loss",
			 card_description: "I'm sorry to hear for your loss. Thinking of you"}, {price: 39.99, occasion: "Mothers Day", card_description: "You are absolutely the best mother ever!"}])
